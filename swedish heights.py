...
can = country.str.contains("SWE") #select players with Swedish nationalities
...
# filter out non-Swedes, modify dataset to include only Canadians
data = data[can == True]
print(data.head())
...
plt.title("Height Distribution of Sweden Born Hockey Players")
